                      ...
                      <div class="project-actions">
                        ...
                        {#if project.project_status === 'open_to_applications'}
                          <a href="/edit/{project.id}" use:link class="action-button">
                            <svg viewBox="0 0 24 24" width="16" height="16" stroke="currentColor" stroke-width="2" fill="none" class="s-XHUcDbuoEbEt"><path d="M15 10l4.553-2.276A1 1 0 0 1 21 8.618v6.764a1 1 0 0 1-1.447.894L15 14M5 18h8a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2z" class="s-XHUcDbuoEbEt"></path></svg>
                            Media
                          </a>
                        {/if}
