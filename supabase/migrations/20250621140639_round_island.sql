/*
  ...
  1. Changes
    - Add `submitted_for_approval` status to project_status_enum
    - Add `approved` boolean column to pieces table (defaults to FALSE)
    - Update piece_details view to include the approved column
    
  2. Security
    - Maintain existing RLS policies
    - Pieces will require approval before being publicly visible
*/

-- First drop the view that depends on the project_status column
...
-- Recreate the piece_details view to include the approved column
