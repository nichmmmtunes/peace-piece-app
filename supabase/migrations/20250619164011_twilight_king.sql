/*
  # Rename poem column to mission in pieces table

  1. Changes
    - Rename `poem` column to `mission` in the `pieces` table
    - Update `piece_details` view to use the new column name
    
  2. Security
    - Maintain existing RLS policies
*/

-- Rename poem column to mission
ALTER TABLE pieces RENAME COLUMN poem TO mission;

-- Drop and recreate the piece_details view to use mission instead of poem
